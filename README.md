...
The [voices-emotion directory](voices-emotion) holds synthetic audio samples produced by using samples from the [voices directory](voices) with [Chatterbox](https://github.com/resemble-ai/chatterbox), to produce emotional variations.
